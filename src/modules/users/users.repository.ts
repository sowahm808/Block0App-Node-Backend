...
export class UsersRepository {
  ...
  async upsert(
    ...
    const entity: AppUser = {
      ...
      timeZone: user.timeZone ?? existing?.timeZone ?? null,
      primaryStudyDevice: user.primaryStudyDevice ?? existing?.primaryStudyDevice ?? null,
      preferredStudyTime: user.preferredStudyTime ?? existing?.preferredStudyTime ?? null,
      activeCohortName: user.activeCohortName ?? existing?.activeCohortName ?? null,
      enrollmentDate: user.enrollmentDate ?? existing?.enrollmentDate ?? null,
      acceptedTerms: user.acceptedTerms ?? existing?.acceptedTerms ?? false,
      acceptedTermsAt: user.acceptedTermsAt ?? existing?.acceptedTermsAt ?? null,
      acceptedTermsVersion: user.acceptedTermsVersion ?? existing?.acceptedTermsVersion ?? null,
      acceptedPrivacyPolicy: user.acceptedPrivacyPolicy ?? existing?.acceptedPrivacyPolicy ?? false,
      acceptedPrivacyPolicyAt:
        user.acceptedPrivacyPolicyAt ?? existing?.acceptedPrivacyPolicyAt ?? null,
      acceptedPrivacyPolicyVersion:
        user.acceptedPrivacyPolicyVersion ?? existing?.acceptedPrivacyPolicyVersion ?? null,
  ...
  map(data: FirebaseFirestore.DocumentData): AppUser {
    ...
    return {
      ...
      primaryStudyDevice: data.primaryStudyDevice ?? null,
      preferredStudyTime: data.preferredStudyTime ?? null,
      activeCohortName: data.activeCohortName ?? null,
      enrollmentDate: data.enrollmentDate ? toDate(data.enrollmentDate) : null,
      acceptedTerms: Boolean(data.acceptedTerms),
      acceptedTermsAt: data.acceptedTermsAt ? toDate(data.acceptedTermsAt) : null,
      acceptedTermsVersion: data.acceptedTermsVersion ?? null,
      acceptedPrivacyPolicy: Boolean(data.acceptedPrivacyPolicy),
      acceptedPrivacyPolicyAt: data.acceptedPrivacyPolicyAt
        ? toDate(data.acceptedPrivacyPolicyAt)
        : null,
