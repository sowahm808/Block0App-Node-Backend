...
export const sampleRewards = [
  ...
  },
  {
    ...
    description: "Complete today's active-recall block to unlock recognition.",
    type: 'recognition',
    earnedDate: null,
    progressCurrent: 0,
    progressTarget: 1,
    eligibilityRequirement: "Complete today's active-recall study block.",
    status: 'locked',
  },
  {
    id: 'seven-day-streak',
    ...
    progressCurrent: 0,
    progressTarget: 7,
    eligibilityRequirement: 'Complete study activity on seven consecutive challenge days.',
    status: 'locked',
  },
];
